...
function HeadingContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="heading_container">
      <div className="flex flex-col font-['Inter',sans-serif] justify-center relative shrink-0 text-[48px] text-[#1A1A1A] text-center tracking-[-1.5px] w-full" style={{ fontWeight: 700 }}>
        <p className="leading-none">Online sjednání pojištění aut</p>
      </div>
    </div>
  );
}
...
function PageHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center overflow-clip relative shrink-0 w-full" data-name="Page Header">
      <StepIndicator />
      <p className="font-['Inter',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#999999] text-[12px] whitespace-nowrap">Krok 6 z 6</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[64px]" data-name="Check Circle Wrap">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 64 64">
        <g clipPath="url(#clip0_18_4059)" id="Check Circle Wrap">
          <circle cx="32" cy="32" fill="var(--fill-0, #e8f8f3)" id="Check BG" r="31" stroke="var(--stroke-0, #00A878)" strokeWidth="2" />
          <g id="lucide/check">
            <path d={svgPaths.p2ce2a3c0} id="Vector" stroke="var(--stroke-0, #00A878)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </g>
        </g>
        <defs>
...
function ContractInfo() {
  return (
    <div className="content-stretch flex flex-col items-center overflow-clip relative shrink-0 w-full" data-name="Contract Info">
      <p className="font-['Inter',sans-serif] leading-[1.7] not-italic relative shrink-0 text-[#666666] text-[14px] text-center whitespace-nowrap">Smlouva č. 1220045130 byla úspěšně sjednána. Smlouvu a veškeré dokumenty najdete ve svém e-mailu. Pro platbu využijte informace níže, nebo QR kód.</p>
    </div>
  );
}
...
function DetailRow1() {
  return (
    <div className="content-stretch flex items-start justify-between overflow-clip relative shrink-0 text-[13px] w-full" data-name="Detail Row">
      ...
      <p className="font-['Inter',sans-serif] font-semibold relative shrink-0 text-[#1A1A1A] text-right">1220045130</p>
    </div>
  );
}
...
function DetailRow4() {
  return (
    <div className="content-stretch flex font-['Inter',sans-serif] items-center justify-between overflow-clip py-[10px] relative rounded-[8px] shrink-0 w-full" data-name="Detail Row">
      ...
      <p className="relative shrink-0 text-[#64748b] text-[16px] text-right" style={{ fontWeight: 700 }}>2 450 Kč</p>
    </div>
  );
}
...
function CtaButton() {
  return (
    <div className="h-[52px] relative rounded-[12px] shadow-[0px_4px_12px_0px_rgba(0,168,120,0.25)] shrink-0 w-full cursor-pointer hover:opacity-90 transition-opacity" data-name="CTA Button" style={{ backgroundColor: "#00A878" }}>
...
function SectionDivider() {
  return <div className="bg-[#E5E7EB] h-px rounded-[1px] shrink-0 w-[80px]" data-name="Section Divider" />;
}
...
function BenefitIcon() {
  return (
    <div className="relative rounded-[10px] shrink-0 size-[32px]" data-name="Benefit Icon" style={{ backgroundImage: "linear-gradient(-90deg, #e8f8f3 100%, #d0f5e8 200%)" }}>
      <div className="content-stretch flex items-center justify-center overflow-clip relative rounded-[inherit] size-full">
        <LucideFolderOpen />
      </div>
      <div aria-hidden="true" className="absolute border border-[#b3e8d5] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
}
...
function RegistrationPromo() {
  return (
    <div className="relative rounded-[16px] shrink-0 w-full" data-name="Registration Promo" style={{ backgroundImage: "linear-gradient(212.668deg, #f0fdf8 50%, #e0f7f0 85.355%, #d0f0e8 120.71%)" }}>
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[20px] items-start p-[28px] relative w-full">
          <PromoHeader />
          <BenefitsList />
          <RegisterButton />
          <p className="font-['Inter',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#999999] text-[11px] text-center w-full">Registrace je zcela zdarma a zabere jen chvilku</p>
        </div>
      </div>
...
export default function CarInsuranceStep6() {
  return (
