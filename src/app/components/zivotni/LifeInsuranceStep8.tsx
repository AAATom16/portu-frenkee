...
function PageHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center overflow-clip relative shrink-0 w-full" data-name="Page Header">
      <StepIndicator />
      <p className="font-['Inter',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#666666] text-[12px] whitespace-nowrap">Krok 8 z 8</p>
    </div>
  );
}
...
function ContractInfo() {
  return (
    <div className="content-stretch flex flex-col items-center overflow-clip relative shrink-0 w-full" data-name="Contract Info">
      <p className="font-['Inter',sans-serif] leading-[1.7] not-italic relative shrink-0 text-[#666666] text-[14px] text-center whitespace-nowrap">Smlouva č. 1220045129 byla úspěšně sjednána. Smlouvu a veškeré dokumenty najdete ve svém e-mailu. Pro platbu využijte informace níže, nebo QR kód.</p>
    </div>
  );
}
...
function DetailRow1() {
  return (
    <div className="content-stretch flex items-start justify-between overflow-clip relative shrink-0 text-[13px] w-full" data-name="Detail Row">
      ...
      <p className="font-['Inter',sans-serif] font-semibold relative shrink-0 text-[#1A1A1A] text-right">1220045129</p>
    </div>
  );
}
...
function DetailRow4() {
  return (
    <div className="content-stretch flex font-['Inter',sans-serif] items-center justify-between overflow-clip py-[10px] relative rounded-[8px] shrink-0 w-full" data-name="Detail Row">
      ...
      <p className="relative shrink-0 text-[#64748b] text-[16px] text-right" style={{ fontWeight: 700 }}>77 Kč</p>
    </div>
  );
}
    ...
    <div className="bg-[#fff2f0] relative rounded-[12px] shrink-0 w-full" data-name="warningBanner">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[12px] items-start px-[16px] py-[14px] relative w-full">
          <LucideTriangleAlert />
          <p className="flex-[1_0_0] font-['Inter',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#8f5000] text-[13px]">Platbu prosím proveďte nejpozději do 24 hodin od sjednání pojištění. Delší prodleva v úhradě může způsobit, že pojistka nebude platit.</p>
        </div>
      </div>
...
function CtaButton() {
  return (
    <div className="h-[52px] relative rounded-[12px] shadow-[0px_4px_12px_0px_rgba(0,168,120,0.25)] shrink-0 w-full cursor-pointer hover:opacity-90 transition-opacity bg-[#00A878]" data-name="CTA Button">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="lucide/file-text">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="lucide/file-text">
          <path d={svgPaths.p28b0a6c0} id="Vector" stroke="#666666" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p2f10900} id="Vector_2" stroke="#666666" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M6.66667 6H5.33333" id="Vector_3" stroke="#666666" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M10.6667 8.66667H5.33333" id="Vector_4" stroke="#666666" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M10.6667 11.3333H5.33333" id="Vector_5" stroke="#666666" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function SecondaryLink() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center overflow-clip relative shrink-0 cursor-pointer hover:opacity-80 transition-opacity" data-name="secondaryLink">
      <LucideFileText />
      <p className="font-['Inter',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#666666] text-[14px] whitespace-nowrap">Stáhnout dokumenty k pojištění</p>
    </div>
  );
}

function SectionDivider() {
  return <div className="bg-[#E5E5E5] h-px rounded-[1px] shrink-0 w-[80px]" data-name="Section Divider" />;
}
...
function PromoHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center not-italic overflow-clip relative shrink-0 text-center w-full whitespace-nowrap" data-name="Promo Header">
      <p className="font-['Inter',sans-serif] leading-[1.3] relative shrink-0 text-[#1A1A1A] text-[18px]" style={{ fontWeight: 700 }}>Zaregistrujte se a mějte vše pod kontrolou</p>
    ...
    <div className="relative shrink-0 size-[16px]" data-name="lucide/folder-open">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="lucide/folder-open">
          <path d={svgPaths.p1975cc00} id="Vector" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function BenefitIcon() {
  return (
    <div className="relative rounded-[10px] shrink-0 size-[32px]" data-name="Benefit Icon" style={{ backgroundImage: "linear-gradient(-90deg, rgb(240, 250, 246) 100%, rgb(224, 245, 237) 200%)" }}>
      <div className="content-stretch flex items-center justify-center overflow-clip relative rounded-[inherit] size-full">
        <LucideFolderOpen />
      </div>
      <div aria-hidden="true" className="absolute border border-[#b3e3c9] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[16px]" data-name="lucide/bell-ring">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_18_4047)" id="lucide/bell-ring">
          <path d={svgPaths.p1ce3c700} id="Vector" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p4c6c80} id="Vector_2" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p1a06de00} id="Vector_3" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p1239d780} id="Vector_4" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
        <defs>
    ...
    <div className="relative shrink-0 size-[16px]" data-name="lucide/badge-percent">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_18_4041)" id="lucide/badge-percent">
          <path d={svgPaths.p21bd6c80} id="Vector" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M10 6L6 10" id="Vector_2" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M6 6H6.00667" id="Vector_3" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M10 10H10.0067" id="Vector_4" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
        <defs>
    ...
    <div className="relative shrink-0 size-[18px]" data-name="lucide/user-plus">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="lucide/user-plus">
          <path d={svgPaths.pd2eb480} id="Vector" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p19685c00} id="Vector_2" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M14.25 6V10.5" id="Vector_3" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M16.5 8.25H12" id="Vector_4" stroke="#00A878" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function RegisterButton() {
  return (
    <div className="bg-white h-[44px] relative rounded-[12px] shrink-0 w-full cursor-pointer hover:opacity-90 transition-opacity" data-name="Register Button">
      ...
      <div aria-hidden="true" className="absolute border-[#00A878] border-[1.5px] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_2px_6px_0px_rgba(0,168,120,0.15)]" />
    </div>
  );
}
...
function RegistrationPromo() {
  return (
    <div className="relative rounded-[16px] shrink-0 w-full" data-name="Registration Promo" style={{ backgroundImage: "linear-gradient(212.668deg, rgb(240, 250, 246) 50%, rgb(224, 245, 237) 85.355%, rgb(210, 240, 228) 120.71%)" }}>
      <div className="overflow-clip rounded-[inherit] size-full">
      ...
      <div aria-hidden="true" className="absolute border border-[#b3e3c9] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_4px_16px_0px_rgba(0,168,120,0.08)]" />
    </div>
  );
}
...
export default function LifeInsuranceStep8() {
  return (
