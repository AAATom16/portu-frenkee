...
function Charts() {
  return (
    <div className="content-stretch flex gap-[24px] items-end justify-end relative shrink-0" data-name="charts">
      {/* Aktivní skupina — 3 zvýrazněné bary + 1 souvislá podtrhávající čára */}
      <div className="flex flex-col items-stretch self-stretch">
        <div className="flex gap-[24px] items-end flex-1">
        ...
        <div className="h-[2px] bg-[#3f2578] rounded-full w-full mt-[4px]" />
      </div>
      {/* Neaktivní bary */}
      <div className="flex flex-row items-end self-stretch">
        <BarContainer3 />
