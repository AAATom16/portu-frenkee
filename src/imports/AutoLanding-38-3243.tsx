import svgPaths from "./svg-8glayr3sxz";
...
function Frame7() {
  return (
    <div className="h-[29.62px] relative shrink-0 w-[139.864px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 139.864 29.62">
        <g id="Frame 10">
          <path clipRule="evenodd" d={svgPaths.p39363e00} fill="url(#paint0_linear_1_1368)" fillRule="evenodd" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1368" x1="139.864" x2="2.11931e-06" y1="4.16827e-06" y2="29.62">
...
function Frame() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[17px] whitespace-nowrap">
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[17px] whitespace-nowrap">
        <p className="leading-[20px]">Majetek</p>
      </div>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[17px] whitespace-nowrap">
        <p className="leading-[20px]">Mazlíčci</p>
      </div>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center p-[4px] relative rounded-[4px] shrink-0">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[17px] whitespace-nowrap">
        <p className="leading-[20px]">Cestování</p>
      </div>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[17px] whitespace-nowrap">
        <p className="leading-[20px]">Odpovědnost</p>
      </div>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[17px] whitespace-nowrap">
        <p className="leading-[20px]">Živnost</p>
      </div>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[17px] whitespace-nowrap">
        <p className="leading-[20px]">Pro firmy</p>
      </div>
    </div>
  );
}
...
function ButtonBase() {
  return (
    <div className="bg-[#3f2578] content-stretch flex items-center justify-center overflow-clip px-[18px] py-[10px] relative rounded-[8px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)] shrink-0" data-name="_Button base">
      <p className="font-['Mona_Sans_VF:Display_ExtraBold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">Registrace</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans_VF:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[17px] whitespace-nowrap">
        <p className="decoration-solid leading-[20px] underline">Kontakt</p>
      </div>
    </div>
  );
}
...
function NavbarHeader() {
  return (
    <div className="bg-white content-stretch flex h-[80px] items-center justify-between px-[24px] py-[12px] relative rounded-[9px] shadow-[0px_4px_8px_0px_rgba(0,0,0,0.15),0px_1px_3px_0px_rgba(0,0,0,0.3)] shrink-0 w-[1200px]" data-name="Navbar header">
      <Frame10 />
      <Frame9 />
      <Frame11 />
      <div className="absolute h-0 left-[495px] top-[54px] w-[81px]">
        <div className="absolute inset-[-2px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 81 2">
            <line id="Line 5" stroke="var(--stroke-0, #3F2578)" strokeWidth="2" x2="81" y1="1" y2="1" />
          </svg>
        </div>
      </div>
    </div>
...
function HeadingContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="heading_container">
      <div className="bg-clip-text flex flex-col font-['Mona_Sans_VF:Display_ExtraBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[48px] text-[transparent] text-center tracking-[-1px] w-full" style={{ backgroundImage: "linear-gradient(231.904deg, rgb(167, 82, 169) 26.752%, rgb(63, 37, 120) 100%)" }}>
...
function Frame29() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['Mona_Sans_VF:Display_Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[18px] whitespace-nowrap">
...
function MingIconFileUploadFill({ className }: { className?: string }) {
  return (
    <div className={className || "overflow-clip relative shrink-0 size-[36px]"} data-name="ming_icon/file_upload_fill">
      <div className="absolute inset-[8.33%_16.67%]" data-name="vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 30">
          <path clipRule="evenodd" d={svgPaths.p1d33a00} fill="var(--fill-0, #94A3B8)" fillRule="evenodd" id="vector" />
        </svg>
      </div>
    </div>
  );
...
function Frame13() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[18px] text-center whitespace-nowrap">
        <p>
          <span className="leading-[1.6]">{`Vyberte soubor `}</span>
          <span className="font-['Mona_Sans_VF:Regular',sans-serif] leading-[1.6] not-italic text-[#94a3b8]">nebo jej zde přesuňte</span>
        </p>
      </div>
    </div>
  );
...
function Summary() {
  return (
    <div className="bg-[#f8fafc] h-[175px] relative rounded-[12px] shrink-0 w-full" data-name="Summary">
...
function Image() {
  return (
    <div className="bg-[#3f2578] h-full relative shrink-0 w-[28px]" data-name="image">
        ...
        <div className="content-stretch flex flex-col items-start justify-between px-[7px] py-[9px] relative size-full">
          ...
          <div className="h-[13.809px] relative shrink-0 w-[14.403px]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.403 13.809">
              <path d={svgPaths.p15f6a1c0} fill="var(--fill-0, #F29E33)" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
...
function Container() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-center justify-center left-1/2 opacity-50 overflow-clip top-[15px]" data-name="Container">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#655193] text-[15px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Input() {
  return (
    <div className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[10px]" data-name="Input">
...
function Frame23() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans_VF:Display_Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[18px] text-center whitespace-nowrap">
...
function ImageFill1() {
  return <div className="flex-[1_0_0] min-h-px min-w-px w-full" data-name="image fill" />;
}
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-col font-['Mona_Sans_VF:Display_Medium',sans-serif] gap-[4px] items-start leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[16px] text-center w-full whitespace-nowrap">
      <div className="flex flex-col justify-center relative shrink-0">
        <p>
          <span className="leading-[1.6]">{`VIN: `}</span>
          <span className="font-['Mona_Sans_VF:Display',sans-serif] leading-[1.6] not-italic">VF38D9HL0BL065925</span>
        </p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0">
        <p>
          <span className="leading-[1.6]">{`Datum první registrace: `}</span>
          <span className="font-['Mona_Sans_VF:Display',sans-serif] leading-[1.6] not-italic">22. 11. 2011</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      ...
      <div className="flex flex-col font-['Mona_Sans_VF:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[14px] whitespace-nowrap">
        <p>
          <span className="leading-[1.6]">cm</span>
          <span className="leading-[1.6] text-[#3f2578] text-[9.030000000000001px]">3</span>
        </p>
      </div>
    </div>
  );
...
function LabelContainer2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="label_container">
      ...
      <div className="flex flex-col font-['Mona_Sans_VF:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[14px] whitespace-nowrap">
        <p className="leading-[1.6]">&nbsp;</p>
      </div>
...
function MingIconSquareLine() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ming_icon/square_line">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ming_icon/square_line">
          <path clipRule="evenodd" d={svgPaths.p291f4e80} fill="var(--fill-0, #CBD5E1)" fillRule="evenodd" id="vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
      ...
      <div className="flex flex-col font-['Mona_Sans_VF:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[16px] whitespace-nowrap">
        <p className="leading-[1.6] whitespace-pre">{`Bylo vozidlo poškozené  minulosti?`}</p>
      </div>
    </div>
  );
}

function MingIconSquareLine1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ming_icon/square_line">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ming_icon/square_line">
...
function Radio1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
      <MingIconSquareLine1 />
      <div className="flex flex-col font-['Mona_Sans_VF:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[16px] whitespace-nowrap">
        <p className="leading-[1.6]">Byla první registrace vozidla mimo území ČR?</p>
      </div>
    </div>
  );
}

function MingIconSquareLine2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ming_icon/square_line">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ming_icon/square_line">
...
function Radio2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
      <MingIconSquareLine2 />
      <div className="flex flex-col font-['Mona_Sans_VF:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[16px] whitespace-nowrap">
        <p className="leading-[1.6]">Je vozidlo v dobrém technickém stavu a nepoškozené?</p>
      </div>
    </div>
  );
}

function MingIconSquareLine3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ming_icon/square_line">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ming_icon/square_line">
...
function Radio3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
      <MingIconSquareLine3 />
      <div className="flex flex-col font-['Mona_Sans_VF:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[16px] whitespace-nowrap">
        <p className="leading-[1.6]">Jste prvním majitelem?</p>
      </div>
    </div>
  );
}
...
function Level() {
  return (
    <div className="relative shrink-0 w-full" data-name="Level">
...
function Text() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[87px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Mona_Sans_VF:Regular',sans-serif] leading-[20px] min-h-px min-w-px not-italic overflow-hidden relative text-[#94a3b8] text-[14px] text-ellipsis whitespace-nowrap">21.1.2026</p>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[192px]" data-name="Calendar 1">
        <Level />
        <Input6 />
      </div>
    </div>
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col h-[77px] items-center relative shrink-0 w-full">
      <Frame17 />
    </div>
  );
}
...
function Header() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full" data-name="Header">
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Previous Month Icon">
        <div className="absolute inset-[22.26%_34.76%_22.26%_33.33%]" data-name="vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.3807 11.0948">
            <path clipRule="evenodd" d={svgPaths.p139d7500} fill="var(--fill-0, #64748B)" fillRule="evenodd" id="vector" />
          </svg>
        </div>
      </div>
      <div className="flex flex-[1_0_0] flex-col font-['Mona_Sans_VF:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#3f2578] text-[16px] text-center">
        <p className="leading-[1.6]">July 2024</p>
      </div>
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Next Month Icon">
        <div className="absolute inset-[22.26%_33.33%_22.26%_34.76%]" data-name="vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.3807 11.0948">
            <path clipRule="evenodd" d={svgPaths.p2c83000} fill="var(--fill-0, #64748B)" fillRule="evenodd" id="vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Component30() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="31">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">31</p>
      </div>
    </div>
  );
}
...
function Component() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="1">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
...
function Component1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="2">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
...
function Component2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="3">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
...
function Component3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="4">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
...
function Component4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="5">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">5</p>
      </div>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="6">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
...
function WeekRow() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative w-full" data-name="Week Row">
      <Component30 />
      <Component />
      <Component1 />
      <Component2 />
...
function Component6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="7">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">7</p>
      </div>
    </div>
  );
}
...
function Component7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="8">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">8</p>
      </div>
    </div>
  );
}
...
function Component9() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="10">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
...
function Component10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="11">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">11</p>
      </div>
    </div>
  );
}
...
function Component11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="12">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">12</p>
      </div>
    </div>
  );
}
...
function Component12() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="13">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">13</p>
      </div>
    </div>
  );
}
...
function Component13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="14">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">14</p>
      </div>
    </div>
  );
}
...
function Component14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="15">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">15</p>
      </div>
    </div>
  );
}
...
function Component15() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="16">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">16</p>
      </div>
    </div>
  );
}

function SelectedDayContainer() {
  return (
    <div className="bg-[#655193] content-stretch flex items-center justify-center p-[5px] relative rounded-[1200px] shrink-0 size-[32px]" data-name="Selected Day Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#f8fafc] text-[14px] text-center whitespace-nowrap">
        <p className="leading-[1.6]">17</p>
      </div>
    </div>
  );
}
...
function DayContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px relative" data-name="Day Container">
...
function Component17() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="18">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">18</p>
      </div>
    </div>
  );
}
...
function Component18() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="19">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">19</p>
      </div>
    </div>
  );
}
...
function Component19() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="20">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
...
function Component20() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="21">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">21</p>
      </div>
    </div>
  );
}
...
function Component21() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="22">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">22</p>
      </div>
    </div>
  );
}
...
function Component22() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="23">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">23</p>
      </div>
    </div>
  );
}
...
function Component23() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="24">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">24</p>
      </div>
    </div>
  );
}
...
function Component24() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="25">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">25</p>
      </div>
    </div>
  );
}
...
function Component25() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="26">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">26</p>
      </div>
    </div>
  );
}
...
function Component26() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="27">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">27</p>
      </div>
    </div>
  );
}
...
function Component27() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="28">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">28</p>
      </div>
    </div>
  );
}
...
function Component28() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="29">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
        <p className="leading-[1.6]">29</p>
      </div>
    </div>
  );
}
...
function Component29() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-center justify-center min-h-px min-w-px overflow-clip relative" data-name="30">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#020617] text-[14px] text-center w-full">
...
function Calendar() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative w-full" data-name="Calendar">
      <WeekRow />
      <WeekRow1 />
      <WeekRow2 />
      <WeekRow3 />
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <Frame16 />
      <div className="bg-white relative rounded-[20px] shrink-0 size-[300px]" data-name="date_time_picker">
        <div className="content-stretch flex flex-col gap-[24px] items-center overflow-clip p-[24px] relative rounded-[inherit] size-full">
          <Header />
          <Calendar />
        </div>
        <div aria-hidden="true" className="absolute border border-[#edf2f7] border-solid inset-0 pointer-events-none rounded-[20px] shadow-[0px_0.301px_1px_0px_rgba(0,0,0,0.02),0px_1.144px_4px_0px_rgba(0,0,0,0.08)]" />
      </div>
    </div>
  );
}
...
function LucideInstagram() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="lucide/instagram">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_34_3029)" id="lucide/instagram">
          <path d={svgPaths.p3bf78600} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p17fbc680} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M14.5833 5.41699H14.5916" id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
        <defs>
    ...
    <div className="relative shrink-0 size-[20px]" data-name="lucide/linkedin">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="lucide/linkedin">
          <path d={svgPaths.p2417b900} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          ...
          <path d={svgPaths.p1dd9ba00} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[20px]" data-name="lucide/facebook">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="lucide/facebook">
          <path d={svgPaths.p28f18400} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function ContactCard() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full" data-name="Contact Card" style={{ backgroundImage: "linear-gradient(-73.762deg, rgb(167, 82, 169) 1.3604%, rgb(63, 37, 120) 99.929%)" }}>
      <div className="overflow-clip rounded-[inherit] size-full">
...
export default function AutoLanding() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full" data-name="Auto landing">
      <NavbarHeader />
      <HeadingContainer />
      <Badge />
      <Badge1 />
