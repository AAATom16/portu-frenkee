import svgPaths from "./svg-po0y6r9oua";
...
function PageHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center overflow-clip relative shrink-0 w-full" data-name="Page Header">
      <StepIndicator />
      <p className="font-['Mona_Sans:Medium',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#8c7cae] text-[12px] whitespace-nowrap">Krok 2 z 4</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">
...
function Frame93() {
  return (
    <div className="content-stretch flex h-[50px] items-center relative shrink-0">
      <Summary />
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="content-stretch flex items-start justify-between leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[18px] text-center w-full whitespace-nowrap">
      <div className="flex flex-col font-['Mona_Sans:Regular',sans-serif] justify-center relative shrink-0">
        <p className="leading-[1.6]">Pojištění úrazu</p>
      </div>
      <div className="flex flex-col font-['Mona_Sans:Bold',sans-serif] justify-center relative shrink-0">
...
function Frame19() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="flex flex-col font-['Mona_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[18px] text-center whitespace-nowrap">
...
function Frame70() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#34c759] text-[18px] text-center whitespace-nowrap">
...
function Frame63() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#8c7cae] text-[14px] w-[229px]">
        <ul>
          <li className="list-disc ms-[21px]">
            <span className="leading-none">Ujma na zdraví a majetku (limit 3 mil. Kč / rok)</span>
          </li>
        </ul>
      </div>
    </div>
...
function Frame68() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <div className="flex flex-col font-['Mona_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#8c7cae] text-[14px] w-[239px]">
        <ul>
          <li className="list-disc ms-[21px]">
    ...
    <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between p-[2px] relative w-full">
          <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[14px] whitespace-nowrap">
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center pb-[25px] pt-[24px] px-[24px] relative w-full">
          <Frame75 />
        </div>
      </div>
    </div>
...
function BarContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-start justify-end relative shrink-0" data-name="bar_container">
      <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[14px] text-center whitespace-nowrap">
        <p className="leading-[1.6]">7 023 Kč</p>
      </div>
      <Bar />
      <p className="font-['Mona_Sans:Regular',sans-serif] leading-[1.6] min-w-full not-italic relative shrink-0 text-[#3f2578] text-[14px] text-center w-[min-content]">AXA</p>
    </div>
  );
}
...
function BarContainer2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-start justify-end relative shrink-0" data-name="bar_container">
      ...
      <Bar2 />
      <p className="font-['Mona_Sans:Regular',sans-serif] leading-[1.6] min-w-full not-italic relative shrink-0 text-[#3f2578] text-[14px] text-center w-[min-content]">Slavia</p>
    </div>
  );
}
...
function BarContainer3() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-start justify-end relative shrink-0" data-name="bar_container">
      <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] text-center whitespace-nowrap">
        <p className="leading-[1.6]">7 023 Kč</p>
      </div>
      <Bar3 />
      <p className="font-['Mona_Sans:Regular',sans-serif] leading-[1.6] min-w-full not-italic relative shrink-0 text-[#94a3b8] text-[14px] text-center w-[min-content]">Generali</p>
    </div>
  );
}
...
function BarContainer4() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-full items-start justify-end relative shrink-0" data-name="bar_container">
      ...
      <Bar4 />
      <p className="font-['Mona_Sans:Regular',sans-serif] leading-[1.6] min-w-full not-italic relative shrink-0 text-[#94a3b8] text-[14px] text-center w-[min-content]">AXA</p>
    </div>
  );
}
...
function BarContainer6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-end relative shrink-0" data-name="bar_container">
      ...
      <Bar6 />
      <p className="font-['Mona_Sans:Regular',sans-serif] leading-[1.6] min-w-full not-italic relative shrink-0 text-[#94a3b8] text-[14px] text-center w-[min-content]">Slavia</p>
    </div>
  );
}
    ...
    <div className="bg-gradient-to-r from-white relative rounded-[12px] shrink-0 to-white w-full" data-name="Travel insurance_company card">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center justify-center p-[24px] relative w-full">
          <Charts />
          <div className="absolute h-0 left-[194px] top-[180px] w-[223px]">
            <div className="absolute inset-[-2px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 223 2">
                <line id="Line 5" stroke="var(--stroke-0, #3F2578)" strokeWidth="2" x2="223" y1="1" y2="1" />
              </svg>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center pb-[64px] pt-[12px] px-[24px] relative w-full">
          <Frame92 />
        </div>
      </div>
    </div>
...
function AutoVyberPojisteni() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip pb-[24px] px-[24px] relative shrink-0 w-[1440px]" data-name="Auto Výběr pojištění">
      <PageHeader />
      <Frame13 />
      <Frame12 />
    </div>
...
export default function Mazlicci() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full" data-name="Mazlicci 2">
      <NavbarHeader />
      <HeadingContainer />
      <Badge />
      <Badge1 />
