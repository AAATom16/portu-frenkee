import svgPaths from "./svg-wrvqge1h3n";
...
import imgChatGptImageFeb62026111803Am1 from "figma:asset/a77fa1f5996ff9eff376c35df3b2900d916bbc66.png";
...
function InputFieldGeneral1() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="input_field_general">
      <InputFieldSkeleton1 />
      <InputFieldSkeleton2 />
    </div>
  );
    ...
    <div className="bg-white h-[40px] relative rounded-bl-[12px] shrink-0 w-full" data-name="input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] relative size-full">
          ...
          <PrefixContainer2 />
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#94a3b8] text-[14px]">
            <p className="leading-[1.6]">Katastrální území</p>
          </div>
          <UserContainer4 />
          <UserContainer5 />
          <UserOtherContainer2 />
    ...
    <div className="bg-white h-[40px] relative rounded-br-[12px] shrink-0 w-full" data-name="input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] relative size-full">
          ...
          <PrefixContainer3 />
          <div className="flex flex-[1_0_0] flex-col font-['Mona_Sans_VF:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#94a3b8] text-[0px]">
            <p className="font-['Mona_Sans_VF:Bold',sans-serif] leading-[1.6] text-[14px]">Číslo parcely</p>
          </div>
          <UserContainer6 />
          <UserContainer7 />
          <UserOtherContainer3 />
...
function Input13() {
  return (
    <div className="bg-[#3f2578] content-stretch flex gap-[8px] h-full items-center overflow-clip px-[12px] relative rounded-[6px] shadow-[0px_0.301px_0.51px_0px_rgba(0,0,0,0.06),0px_1.144px_2.72px_0px_rgba(0,0,0,0.02)] shrink-0" data-name="input">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">
        <p className="leading-[1.6]">Stavební</p>
      </div>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex font-['Mona_Sans_VF:Bold',sans-serif] gap-[10px] items-center justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">
      <div className="flex flex-col justify-center relative shrink-0">
        <p className="leading-[1.6]">Pozemková</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0">
        <p className="leading-[1.6]">Nemá přidělený typ</p>
      </div>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[18px] text-center whitespace-nowrap">
        <p className="leading-[1.6]">Domácnost je v dobrém stavu a bez chátrajících prvků</p>
      </div>
      <Frame22 />
    </div>
  );
...
function Badge() {
  return (
    <div className="absolute bg-[#ebecff] content-stretch flex h-[40px] items-center left-[131px] px-[12px] py-[2px] rounded-[8px] top-[4199px]" data-name="badge">
      ...
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-white whitespace-nowrap">
...
function Badge1() {
  return (
    <div className="absolute bg-[#ebecff] content-stretch flex h-[20px] items-center left-[876px] px-[6px] py-px rounded-[4px] top-[4187px]" data-name="badge">
      ...
      <div className="flex flex-col font-['Mona_Sans_VF:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#a752a9] text-[9px] whitespace-nowrap">
...
export default function Majetek1A() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full" data-name="Majetek 1A">
      <NavbarHeader />
      <HeadingContainer />
      <Frame12 />
      <Badge />
      ...
      <Badge3 />
      <Badge4 />
      <div className="absolute h-[476px] left-[-54px] top-[438px] w-[317px]" data-name="ChatGPT Image Feb 6, 2026, 11_18_03 AM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgChatGptImageFeb62026111803Am1} />
      </div>
      <FooterNew />
    </div>
  );
