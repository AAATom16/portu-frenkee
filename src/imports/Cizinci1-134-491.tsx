import svgPaths from "./svg-dp9k3x4dps";
...
import imgChatGptImageMar202026010957Pm1 from "figma:asset/36f2b4ab8a7a04b41d3c6b2f1421ab9ead156e14.png";
...
function NavbarHeader() {
  return (
    <div className="absolute bg-white content-stretch flex h-[80px] items-center justify-between left-[120px] px-[24px] py-[12px] rounded-[9px] shadow-[0px_4px_8px_0px_rgba(0,0,0,0.15),0px_1px_3px_0px_rgba(0,0,0,0.3)] top-[24px] w-[1200px]" data-name="Navbar header">
      <Frame11 />
      <Frame10 />
      <Frame12 />
...
function HeadingContainer() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] top-[128px] w-[1392px]" data-name="heading_container">
...
function PageHeader() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-center left-[24px] overflow-clip top-[200px] w-[1392px]" data-name="Page Header">
      <StepIndicator />
      <p className="font-['Mona_Sans:Medium',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#8c7cae] text-[12px] whitespace-nowrap">Krok 1 z 4</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="absolute left-[-3px] size-[100px] top-[2px]">
      <div className="absolute bg-[#3f2578] h-[100px] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_-21px] mask-size-[100px_100px] top-[21px] w-[101px]" style={{ maskImage: `url('${imgRectangle2}')` }} />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="h-[180px] relative rounded-[8px] shrink-0 w-[285px]">
      <div className="content-stretch flex flex-col gap-[4px] items-center overflow-clip p-[12px] relative rounded-[inherit] size-full">
        ...
        <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3f2578] text-[16px] text-center whitespace-nowrap">
...
function Frame17() {
  return (
    <div className="bg-white h-[180px] relative rounded-[9px] shrink-0 w-[285px]">
      <div className="content-stretch flex flex-col gap-[8px] items-center overflow-clip p-[12px] relative rounded-[inherit] size-full">
        ...
        <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#3f2578] text-[16px] text-center w-[min-content]">
          <p className="leading-[1.6]">Komplexní pěče</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#64748b] border-solid inset-0 pointer-events-none rounded-[9px]" />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-[591px]">
      <Frame14 />
      <Frame17 />
    </div>
  );
...
function Frame39() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['Mona_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">
...
function Frame22() {
  return (
    <div className="relative rounded-[8px] shrink-0 size-[180px]">
...
function Frame23() {
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 size-[180px]">
      <div className="content-stretch flex flex-col gap-[4px] items-center justify-end overflow-clip p-[12px] relative rounded-[inherit] size-full">
...
function CheckboxRow() {
  return (
    <div className="content-stretch flex gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Checkbox Row 1">
      <Chk1Box />
      <p className="font-['Mona_Sans:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#3f2578] text-[14px] whitespace-nowrap">Jste těhotná, nebo plánujete otěhotnět v době trvání pojištění?</p>
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="ming_icon/information_line">
        <div className="absolute inset-[8.33%]" data-name="vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <path d={svgPaths.p13035d50} fill="var(--fill-0, #94A3B8)" id="vector" />
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[592px]">
      <Frame20 />
      <Frame21 />
      <CheckboxRow />
    </div>
...
function Text() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[87px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Mona_Sans:Regular',sans-serif] leading-[20px] min-h-px min-w-px not-italic overflow-hidden relative text-[#94a3b8] text-[14px] text-ellipsis whitespace-nowrap">21.1.2026</p>
    </div>
  );
}
...
function CheckboxRow1() {
  return (
    <div className="content-stretch flex gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Checkbox Row 1">
      <Chk1Box1 />
      <p className="font-['Mona_Sans:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#3f2578] text-[14px] whitespace-nowrap">Jste profesionální sportovec?</p>
    </div>
  );
}
...
function CheckboxRow2() {
  return (
    <div className="content-stretch flex gap-[12px] items-start overflow-clip relative shrink-0 w-full" data-name="Checkbox Row 2">
      <Chk1Box2 />
      <p className="font-['Mona_Sans:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#3f2578] text-[14px] whitespace-nowrap">Léčíte se?</p>
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="ming_icon/information_line">
        <div className="absolute inset-[8.33%]" data-name="vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <path d={svgPaths.p13035d50} fill="var(--fill-0, #94A3B8)" id="vector" />
...
function Text2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[87px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Mona_Sans:Regular',sans-serif] leading-[20px] min-h-px min-w-px not-italic overflow-hidden relative text-[#94a3b8] text-[14px] text-ellipsis whitespace-nowrap">Ano</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
      <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
        ...
        <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[16px] whitespace-nowrap">
      ...
      <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
        ...
        <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[16px] whitespace-nowrap">
          <p className="leading-[1.6]">6 měsíců</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="ming_icon/round_line">
      ...
      <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
        ...
        <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[16px] whitespace-nowrap">
          <p className="leading-[1.6]">2 roky</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="radio_button_fill">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
            <g id="Group">
              <g id="Vector" />
              <path d={svgPaths.pbbdde00} fill="var(--fill-0, #655193)" id="Vector_2" />
            </g>
          </svg>
        </div>
        <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[16px] whitespace-nowrap">
          <p className="leading-[1.6]">Vlastní hodnota</p>
        </div>
      </div>
    </div>
  );
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-center justify-center left-[325px] overflow-clip pb-[340px] pt-[24px] px-[99px] top-[253px]">
      <Frame27 />
      <Frame37 />
...
export default function Cizinci() {
  return (
    <div className="bg-white relative size-full" data-name="Cizinci 1">
      <div className="absolute h-[52px] left-[1131px] top-[819px] w-[251px]">
        <div className="absolute inset-[-56.35%_-11.67%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 309.6 110.6">
            <g filter="url(#filter0_f_131_551)" id="Ellipse 3">
              <ellipse cx="154.8" cy="55.3" fill="var(--fill-0, black)" fillOpacity="0.5" rx="125.5" ry="26" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="110.6" id="filter0_f_131_551" width="309.6" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_131_551" stdDeviation="14.65" />
              </filter>
            </defs>
          </svg>
        </div>
      </div>
      <div className="absolute h-[103px] left-[1295px] top-[754px] w-[171px]">
        <div className="absolute inset-[-15.24%_-9.18%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 202.4 134.4">
            <g filter="url(#filter0_f_131_553)" id="Vector 3">
              <path d={svgPaths.p37dd2600} fill="var(--fill-0, black)" fillOpacity="0.25" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="134.4" id="filter0_f_131_553" width="202.4" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_131_553" stdDeviation="7.85" />
              </filter>
            </defs>
          </svg>
        </div>
      </div>
      <div className="absolute h-[99.5px] left-[1192px] top-[739px] w-[138.5px]">
        <div className="absolute inset-[-15.78%_-11.34%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 169.9 130.9">
            <g filter="url(#filter0_f_131_539)" id="Vector 4">
              <path d={svgPaths.pbbccc00} fill="var(--fill-0, black)" fillOpacity="0.25" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="130.9" id="filter0_f_131_539" width="169.9" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_131_539" stdDeviation="7.85" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <PageHeader />
      <Frame13 />
      <div className="absolute h-[561px] left-[1049px] top-[324px] w-[374px]" data-name="ChatGPT Image Mar 20, 2026, 01_09_57 PM 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgChatGptImageMar202026010957Pm1} />
      </div>
    </div>
  );
}