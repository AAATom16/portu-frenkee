import svgPaths from "./svg-ew0thnlpgj";
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center pb-[340px] pt-[24px] px-[99px] relative shrink-0">
      <Frame13 />
    </div>
  );
}
...
export default function Majetek4A() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full" data-name="Majetek 4A">
      <NavbarHeader />
      <HeadingContainer />
      <Badge />
      <Badge1 />
