import svgPaths from "./svg-elmb759s6k";
...
function PageHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center overflow-clip relative shrink-0 w-full" data-name="Page Header">
      <StepIndicator />
      <p className="font-['Mona_Sans_VF:Medium',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#8c7cae] text-[12px] whitespace-nowrap">Krok 7 z 8</p>
    </div>
  );
}
...
function FormInner() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Form Inner">
      <PageHeader1 />
      <CardOsobniUdaje />
      <CardPrijmy />
      <CardMajetek />
...
export default function Zivot() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full" data-name="Život 7">
      <NavbarHeader />
      <HeadingContainer />
      <Badge />
      <Badge1 />
      ...
      <Badge4 />
      <Frame12 />
      <div className="absolute h-[357.358px] left-[1071px] top-[440px] w-[426.001px]" data-name="ChatGPT Image Jan 22, 2026, 01_41_37 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[178.81%] left-0 max-w-none top-[-30.38%] w-full" src={imgChatGptImageJan222026014137Pm1} />
        </div>
      </div>
      <FooterNew />
    </div>
