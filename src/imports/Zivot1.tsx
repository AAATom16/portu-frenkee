import svgPaths from "./svg-su31xquzkk";
...
function Text() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[87px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic overflow-hidden relative text-[#94a3b8] text-[14px] text-ellipsis whitespace-nowrap">25.6.2025</p>
    </div>
  );
}
...
function Input3() {
  return (
    <div className="bg-white h-[40px] relative rounded-[8px] shrink-0 w-[400px]" data-name="input">
      <div className="content-stretch flex items-center justify-between overflow-clip pl-[4px] pr-[8px] py-[4px] relative rounded-[inherit] size-full">
        <Input4 />
        <Frame25 />
        <Frame24 />
      </div>
  ...
  return (
    <div className="bg-white h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Mona_Sans_VF:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#94a3b8] text-[14px]">
            <p className="leading-[1.6]">Programátor</p>
          </div>
...
export default function Zivot() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full" data-name="Život 1">
      ...
      <Badge4 />
      <Frame12 />
      <div className="absolute h-[476px] left-[71px] top-[438px] w-[317px]" data-name="ChatGPT Image Feb 6, 2026, 11_18_03 AM 1">
