import svgPaths from "./svg-bat2004qpz";
...
function PageHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center overflow-clip relative shrink-0 w-full" data-name="Page Header">
      <StepIndicator />
      <p className="font-['Mona_Sans:Medium',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#8c7cae] text-[12px] whitespace-nowrap">Krok 4 z 8</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col items-start leading-[1.4] not-italic relative shrink-0 text-[#3f2578]">
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[18px] whitespace-nowrap">Finanční zázemí</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[10px] w-[475px]">Potřebujeme znát vaši finanční situaci, abychom vám mohli doporučit vhodnou investici vzhledem k vašemu finančnímu zázemí.</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] not-italic relative shrink-0 text-[#3f2578] text-[14px] w-[495px]">Zhoršila by se vaše životní úroveň, kdyby hodnota vaší plánované investice značně poklesla?</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
        ...
        <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
          <p className="leading-[1.6]">Ne, dopad by byl malý nebo žádný</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[2px] relative w-full">
            ...
            <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
              <p className="leading-[1.6]">Mírně, mohlo by ji to negativně ovlivnit.</p>
            </div>
          </div>
        </div>
      </div>
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[2px] relative w-full">
            ...
            <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
              <p className="leading-[1.6]">Ano, moje životní úroveň by výrazně poklesla.</p>
            </div>
          </div>
        </div>
      </div>
...
function Frame13() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] not-italic relative shrink-0 text-[#3f2578] text-[14px] w-[525px]">Jaký je přibližně váš pravidelný roční příjem po zdanění?</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
        ...
        <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
          <p className="leading-[1.6]">Do 100 000 Kč</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[2px] relative w-full">
            ...
            <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
              <p className="leading-[1.6]">100 000 Kč až 500 000 Kč</p>
            </div>
          </div>
        </div>
      </div>
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[2px] relative w-full">
            ...
            <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
              <p className="leading-[1.6]">500 000 Kč až 1 000 000 Kč</p>
            </div>
          </div>
        </div>
      </div>
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[2px] relative w-full">
            ...
            <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
              <p className="leading-[1.6]">1 000 000 Kč a více</p>
            </div>
          </div>
        </div>
      </div>
...
function Frame15() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] not-italic relative shrink-0 text-[#3f2578] text-[14px] w-[525px]">Na kolik odhadujete hodnotu svého majetku? Včetně hotovosti, movitých věcí, investic a nemovitostí.</p>
    </div>
  );
}
      ...
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[2px] relative w-full">
            ...
            <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
              <p className="leading-[1.6]">1 000 000 Kč až 10 000 000 Kč.</p>
            </div>
          </div>
        </div>
      </div>
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[2px] relative w-full">
            ...
            <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
              <p className="leading-[1.6]">10 000 000 Kč a více.</p>
            </div>
          </div>
        </div>
      </div>
...
function Frame17() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.4] not-italic relative shrink-0 text-[#3f2578] text-[14px] w-[525px]">Kolik z vašich měsíčních čistých příjmů vynaložíte na pravidelné splátky půjček nebo jiných finančních závazků?</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <div className="content-stretch flex gap-[8px] items-center p-[2px] relative rounded-[2px] shrink-0" data-name="radio">
        ...
        <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
          <p className="leading-[1.6]">Nic nebo nejvýše třetinu (0 až 33 %)</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[2px] relative w-full">
            ...
            <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
              <p className="leading-[1.6]">Něco mezi třetinou a polovinou (33 až 50 %)</p>
            </div>
          </div>
        </div>
      </div>
      <div className="relative rounded-[2px] shrink-0 w-full" data-name="radio">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[2px] relative w-full">
            ...
            <div className="flex flex-col font-['Mona_Sans:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#321e60] text-[12px] whitespace-nowrap">
              <p className="leading-[1.6]">Většinu (nad 50 %)</p>
            </div>
          </div>
        </div>
      </div>
...
function Frame23() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[1154px] items-center relative shrink-0 w-full">
      <Frame24 />
      <Frame10 />
    </div>
  );
...
export default function Investice() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full" data-name="Investice 4">
      <Badge />
      <Badge1 />
      <Badge2 />
      <Badge3 />
